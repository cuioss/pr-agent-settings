...
* A **clean review publishes nothing** under `publish_output_no_suggestions = false` (our
setting, to suppress "No major issues detected" noise). A working reviewer that found no issues
